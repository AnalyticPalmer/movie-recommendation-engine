...
# ---------------------------------------------------------
# These variables must be set BEFORE importing pandas,
# NumPy, SciPy, or the collaborative filtering model.
...
def evaluate_model(top_k=10):
    ...
    for _, row in test.iterrows():
        ...
        # Skip users not present in training data
